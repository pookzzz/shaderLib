...
float Noise = 2.0;
float NoiseFreq = 0.47;
float NoiseAmp = 5.23;
float brightness = 0.32;
float contrast = 2.0;
float saturation = 0.1;
float tint = 0.4;
vec3 tint_col = vec3(3.8, 0.8, -0.8);
vec3 NoiseAnim = vec3(0.1, -4.0, -0.1);
vec3 co0 = vec3(1.1, 2.3, 0.8);
vec3 co1 = vec3(2.1, 0.5, 0.5);
vec3 co2 = vec3(0.0, 0.0, 0.0);
vec3 co3 = vec3(1.5, -1.2, -1.3);
vec3 co4 = vec3(3.0, 0.0, 0.0);
