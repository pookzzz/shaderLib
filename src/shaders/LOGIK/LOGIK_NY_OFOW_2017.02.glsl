...
float time = adsk_time *.025;
float iGlobalTime = time + 500.;
...
vec3 sundir = normalize(vec3 ( -1.0,0.3,0.20));
vec3 haloclr1 = vec3(0.7,0.6,0.3);
vec3 haloclr2 = vec3(0.7,0.68,0.5);
