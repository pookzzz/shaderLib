...
void main(void)
{
	...
	// Amsterdam
	d += A(r()); add(); d += M(r()); add(); d += S(r()); add(); d += T(r()); add(); d += E(r()); add(); d += R(r()); add(); d += D(r()); add(); d += A(r()); add(); d += M(r()); add(); add();

  // LOGIK
	d += I(r()); add(); d += B(r()); add(); d += C(r()); add(); add();


  // LOGIK
	d += L(r()); add(); d += O(r()); add(); d += G(r()); add(); d += I(r()); add(); d += K(r()); space();
