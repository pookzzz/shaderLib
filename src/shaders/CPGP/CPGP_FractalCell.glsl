...
void main()
{
    ...
    {
	freqs[0] = texture2D( inputNoise, vec2( 0.01, 0.25 ) ).x;
	freqs[1] = texture2D( inputNoise, vec2( 0.07, 0.25 ) ).x;
	freqs[2] = texture2D( inputNoise, vec2( 0.15, 0.25 ) ).x;
	freqs[3] = texture2D( inputNoise, vec2( 0.30, 0.25 ) ).x;
    }
    else
    {
    freqs[0] = 0.5;
